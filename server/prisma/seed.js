...
async function main() {
  ...
  if (!cashierExists) {
    await prisma.user.create({
      data: { name: 'Cashier 1', email: 'cashier@pos.com', password: await bcrypt.hash('cashier123', 10), role: 'CASHIER' }
    });
    console.log('✅ Cashier user created (cashier@pos.com / cashier123)');
  }
